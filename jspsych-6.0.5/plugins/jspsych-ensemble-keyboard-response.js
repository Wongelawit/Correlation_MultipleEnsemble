...
jsPsych.plugins["ensemble-keyboard-response"] = (function() {
  ...
  plugin.info = {
    ...
    parameters: {
	  ...
	  population_ratio: {
        ...
        array: true,
        default: 1,
        description: 'Number specifying ratio of target to distractor.'
      }
      /* distractor_number: {
        type: jsPsych.plugins.parameterType.INT,
  ...
  plugin.trial = function(display_element, trial) {
	...
	pops = generate_sizes(trial.population_ratio);
	target_number = pops[0];
	distractor_number = pops[1];
	
    var new_html = plugin.generate_stimulus(trial.stimuli, trial.grid_size, distractor_number, target_number);
  ...
  /**
   * Generates random population sizes within bounds [30,200]
   * given a ratio.
   *
   * @param  ratio                   {int}
